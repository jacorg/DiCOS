...
uint32_t getContextoSiguiente(uint32_t sp_actual)  {
	 ...
	 * sp_siguiente el valor del stack pointer de la tarea3
	 */
	case 2:
		sp_tarea2 = sp_actual;
     ...
     /**
	 * Tarea actual es tarea3. Recuperamos el stack pointer (MSP) y lo
	 * almacenamos en sp_tarea3. Luego cargamos en la variable de retorno
